...
I am now going to construct a table with some play history that I got from my lastfm data. The history column of this table contains a histogram that shows the number of times I played each album over each month.
